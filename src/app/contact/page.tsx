        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div className="flex-1">
            ...
            <StaggerChildren delay={0.8} className="flex flex-wrap gap-4">
              ...
              <StaggerItem>
                <Link href="https://drive.google.com/file/d/1qox2JU3CZyjwZ1bCDpofQUOgTrTGCg62/view?usp=sharing" target="_blank">
                  <AnimatedButton variant="outline" size="lg" className="gap-2 rounded-full">
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <motion.div className="flex items-start gap-4" whileHover={{ x: 5 }} transition={{ duration: 0.2 }}>
                    ...
                    <div>
                      <a href="tel:+1234567890" className="text-gray-700 hover:text-sky-600 transition-colors">
                        +1 (234) 567-8900
                      </a>
                    </div>
                  </motion.div>
                  ...
                  <motion.div className="flex items-start gap-4" whileHover={{ x: 5 }} transition={{ duration: 0.2 }}>
                    ...
                    <div>
                      <span className="text-gray-700">Durham, North Carolina, USA</span>
                    </div>
                  </motion.div>
                </div>
